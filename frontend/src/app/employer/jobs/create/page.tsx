...
export default function CreateJob() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await employerAPI.createJob(token!, formData);
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">Fill in the details for your new job opening</p>
          </div>

          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Job Details</h3>
              <p className="mt-1 text-sm text-gray-500">Provide information about the position you're hiring for</p>
            </div>
